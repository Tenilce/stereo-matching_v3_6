...
% Segmentation (by Mean Shif) Plus Mode Area Algorithm
 ...
 % D_out = scc(I1,D,39,18,7,7,5,1,[23],39,39);
 % with bilateral filter
 % D_out = scc(I1,D,39,18,7,7,5,1,[23,14],39,39);
 %
 % it doens't apply texturelessRegions and final filtering
 % D_out = scc(I1,D,1,1,7,7,5,1,23,39,39);
 
 % Prepared by: Gabriel da Silva Vieira (Jan 2018)

function [D_out, D_holes] = scc(I, D, windowSize, thresh, hs, hr, M,...
