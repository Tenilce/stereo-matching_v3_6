...
% Example:
% [dl,dr] = MLMH(I1,I2,0,15,0,0,'SSD',1,0.0009);
...
function [dl, dr] = MLMH(I1, I2, min_d, max_d, h, w, method, reverse, occ)

%I1 = im2double(I1);
%I2 = im2double(I2);

% Execute block_matching to construct the DSI matrix
[D, C_min, C1] = block_matching(I1, I2, min_d, max_d, h, w, method, reverse);
