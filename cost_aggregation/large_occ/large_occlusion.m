...
%
% Example:
% D = large_occlusion(I1,I2,0,15,0,0,'SAD',0.009);
...
% Prepared by: Gabriel da Silva Vieira (May 2017)



function D = large_occlusion(I1, I2, min_d, max_d, h, w, method, disparityPenalty, reverse)
...
[D1, C_min1, C1] = block_matching(I1, I2, min_d, max_d, h, w, method, reverse);

[h_disp, w_disp] = size(DSI);
